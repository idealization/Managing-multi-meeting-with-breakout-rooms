...
const MeetingRooms: React.FC = () => {
  ...
  const handleJoinMeeting = async (
    ...
    const id = meetingName.trim().toLocaleLowerCase();
    ...
    try {
      ...
      console.log(appMainMeetingId, meetingId, id)
      //load breakout rooms
      const currentBreakoutRooms = await getBreakouts(appIsBreakout? appMainMeetingId:id);

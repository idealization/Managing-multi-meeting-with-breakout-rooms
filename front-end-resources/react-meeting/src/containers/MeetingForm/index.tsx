...
import { fetchMeeting, createGetAttendeeCallback, fetchActiveMeetings, getBreakouts } from '../../utils/api';
...
const MeetingForm: React.FC = () => {
  ...
  const handleJoinMeeting = async (e: React.FormEvent) => {
    ...
    try {
      ...
      //load breakout rooms
      console.log(appIsBreakout, appMainMeetingId, meetingId);
      const currentBreakoutRooms = await getBreakouts(appIsBreakout? appMainMeetingId:meetingId);
      setAppMeetingInfo(meetingArray, id, attendeeName, region, false, currentBreakoutRooms);
      console.log(meetingArray, id, attendeeName, region, false, currentBreakoutRooms);
